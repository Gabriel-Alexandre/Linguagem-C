...
int main(void)
{
    // Obs: O processo de separar strings a partir de um caracter comum é chamado que tokerização
    // A função em c que poder realizar essa execução é strtok((array de caracters), String referência)
