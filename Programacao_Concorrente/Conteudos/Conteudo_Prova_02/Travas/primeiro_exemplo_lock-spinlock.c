...
// Solução probelmática, porque além de funcionar apenas para duas threads, o protocolo de entrada não é atômico.
...
void *cs1(void *p)
{
    while (1)
    {
        //<await (!in2) in1 = 1;> //protocolo de entrada (deveria ser atomico)
